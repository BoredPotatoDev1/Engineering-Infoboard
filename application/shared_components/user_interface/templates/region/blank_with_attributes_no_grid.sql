...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66193884004696991407)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193884389562991407)
,p_plug_template_id=>wwv_flow_imp.id(66193884004696991407)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193884688727991407)
,p_plug_template_id=>wwv_flow_imp.id(66193884004696991407)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193884929996991407)
,p_plug_template_id=>wwv_flow_imp.id(66193884004696991407)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193885265236991407)
,p_plug_template_id=>wwv_flow_imp.id(66193884004696991407)
,p_name=>'Sub Regions'
