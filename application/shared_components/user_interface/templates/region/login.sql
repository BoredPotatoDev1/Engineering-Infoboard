...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194544038165991433)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194544340276991433)
,p_plug_template_id=>wwv_flow_imp.id(66194544038165991433)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194544691496991433)
,p_plug_template_id=>wwv_flow_imp.id(66194544038165991433)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194544908552991433)
,p_plug_template_id=>wwv_flow_imp.id(66194544038165991433)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194545207828991433)
,p_plug_template_id=>wwv_flow_imp.id(66194544038165991433)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194545522235991433)
,p_plug_template_id=>wwv_flow_imp.id(66194544038165991433)
,p_name=>'Sub Regions'
