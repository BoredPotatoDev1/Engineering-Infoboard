...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194559095541991439)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194559385441991439)
,p_plug_template_id=>wwv_flow_imp.id(66194559095541991439)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194559648052991439)
,p_plug_template_id=>wwv_flow_imp.id(66194559095541991439)
,p_name=>'Tabs'
