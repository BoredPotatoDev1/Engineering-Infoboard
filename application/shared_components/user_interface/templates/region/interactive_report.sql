...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194539497144991431)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194539789723991431)
,p_plug_template_id=>wwv_flow_imp.id(66194539497144991431)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194540053774991431)
,p_plug_template_id=>wwv_flow_imp.id(66194539497144991431)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194540370859991431)
,p_plug_template_id=>wwv_flow_imp.id(66194539497144991431)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194540616816991431)
,p_plug_template_id=>wwv_flow_imp.id(66194539497144991431)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194540978699991432)
,p_plug_template_id=>wwv_flow_imp.id(66194539497144991431)
,p_name=>'Sub Regions'
