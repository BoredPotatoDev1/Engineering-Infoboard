...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194546549554991434)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194546817089991434)
,p_plug_template_id=>wwv_flow_imp.id(66194546549554991434)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194547170936991434)
,p_plug_template_id=>wwv_flow_imp.id(66194546549554991434)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194547417722991434)
,p_plug_template_id=>wwv_flow_imp.id(66194546549554991434)
,p_name=>'Sub Regions'
