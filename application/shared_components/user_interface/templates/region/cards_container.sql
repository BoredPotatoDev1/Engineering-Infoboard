...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66193889779112991409)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193890045311991409)
,p_plug_template_id=>wwv_flow_imp.id(66193889779112991409)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193890338586991409)
,p_plug_template_id=>wwv_flow_imp.id(66193889779112991409)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193890603953991409)
,p_plug_template_id=>wwv_flow_imp.id(66193889779112991409)
,p_name=>'Sub Regions'
