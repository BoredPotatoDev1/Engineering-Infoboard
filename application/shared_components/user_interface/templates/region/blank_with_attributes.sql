...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66193882636156991406)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193882910213991406)
,p_plug_template_id=>wwv_flow_imp.id(66193882636156991406)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193883262743991406)
,p_plug_template_id=>wwv_flow_imp.id(66193882636156991406)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193883592901991406)
,p_plug_template_id=>wwv_flow_imp.id(66193882636156991406)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193883883059991407)
,p_plug_template_id=>wwv_flow_imp.id(66193882636156991406)
,p_name=>'Sub Regions'
