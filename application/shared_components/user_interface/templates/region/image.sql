...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194519455787991423)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194519761164991423)
,p_plug_template_id=>wwv_flow_imp.id(66194519455787991423)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194520051321991423)
,p_plug_template_id=>wwv_flow_imp.id(66194519455787991423)
,p_name=>'Sub Regions'
