...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194511362312991417)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194511637134991417)
,p_plug_template_id=>wwv_flow_imp.id(66194511362312991417)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194511959949991418)
,p_plug_template_id=>wwv_flow_imp.id(66194511362312991417)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194512213856991418)
,p_plug_template_id=>wwv_flow_imp.id(66194511362312991417)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194512541186991418)
,p_plug_template_id=>wwv_flow_imp.id(66194511362312991417)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194512875690991418)
,p_plug_template_id=>wwv_flow_imp.id(66194511362312991417)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194513199510991418)
,p_plug_template_id=>wwv_flow_imp.id(66194511362312991417)
,p_name=>'Sub Regions'
