...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194515901093991419)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194516208828991420)
,p_plug_template_id=>wwv_flow_imp.id(66194515901093991419)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194516559740991420)
,p_plug_template_id=>wwv_flow_imp.id(66194515901093991419)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194516828947991420)
,p_plug_template_id=>wwv_flow_imp.id(66194515901093991419)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194517150943991420)
,p_plug_template_id=>wwv_flow_imp.id(66194515901093991419)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194517427228991420)
,p_plug_template_id=>wwv_flow_imp.id(66194515901093991419)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
