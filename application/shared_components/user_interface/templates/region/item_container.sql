...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66194541510039991432)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194541801586991432)
,p_plug_template_id=>wwv_flow_imp.id(66194541510039991432)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194542122061991432)
,p_plug_template_id=>wwv_flow_imp.id(66194541510039991432)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66194542436499991432)
,p_plug_template_id=>wwv_flow_imp.id(66194541510039991432)
,p_name=>'Button Start'
