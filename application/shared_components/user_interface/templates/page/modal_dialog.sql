...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(66193867330584991400)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193867684565991400)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193867959032991400)
,p_page_template_id=>wwv_flow_imp.id(66193867330584991400)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193868276828991400)
,p_page_template_id=>wwv_flow_imp.id(66193867330584991400)
