...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(66193846776143991391)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193847089946991391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193847351662991391)
,p_page_template_id=>wwv_flow_imp.id(66193846776143991391)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193847697793991391)
,p_page_template_id=>wwv_flow_imp.id(66193846776143991391)
