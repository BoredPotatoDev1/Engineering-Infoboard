...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(66193857334264991396)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193857645674991396)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193857977393991396)
,p_page_template_id=>wwv_flow_imp.id(66193857334264991396)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193858232413991396)
,p_page_template_id=>wwv_flow_imp.id(66193857334264991396)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193858574566991396)
,p_page_template_id=>wwv_flow_imp.id(66193857334264991396)
,p_name=>'Body Footer'
