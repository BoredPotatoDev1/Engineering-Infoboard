...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(66193875930579991403)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193876248442991403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193876590369991403)
,p_page_template_id=>wwv_flow_imp.id(66193875930579991403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66193876867240991403)
,p_page_template_id=>wwv_flow_imp.id(66193875930579991403)
